...
DATABASES = {
    # Get the DATABASE_URL from your environment variables
...
# --- Session Management (OWASP ASVS V2) ---
SESSION_COOKIE_AGE = 900            # 15 minutes
SESSION_SAVE_EVERY_REQUEST = True   # refresh expiry on activity
SESSION_EXPIRE_AT_BROWSER_CLOSE = True


# --- Secure Cookies (OWASP ASVS V2) ---
SESSION_COOKIE_HTTPONLY = True
CSRF_COOKIE_HTTPONLY = True

# Set True only when using HTTPS (production)
